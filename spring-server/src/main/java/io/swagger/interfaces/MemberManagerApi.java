...
public interface MemberManagerApi {
    ...
    ResponseEntity<Void> deleteUser(@ApiParam(value = "information of a user to delete",required=true) @PathVariable("username") String username);
    ...
    ResponseEntity<MemberManager> getSingleUserInformation(@ApiParam(value = "information of a user to return",required=true) @PathVariable("username") String username);
